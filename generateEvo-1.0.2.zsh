...
fun () {
  ...
  (! mvn compile) && { echo mvn $errorMsg; return 1}
...
# 对一个文目录下的所有项目测试, 并压缩所有项目的结果文件statistics.csv到results.zip
#
doAll () {
  cd $1
  ...
  for dir ($dirList) {
    cd $1
    echo  "\033[32;10m ======================= processing: [ $dir ] ======================== \033[0m"
    fun $dir
  }
  echo "===================== zipping results ... ================="
  (! zip results.zip ./**/evosuite-report/statistics.csv) && {echo zip $errorMsg; return 1}
}
